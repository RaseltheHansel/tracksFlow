...
Event.init({
  ...
  sequelize,
  tableName:  'events',
  timestamps: true, // ← WHY: tells Sequelize to manage createdAt/updatedAt
  indexes: [
    // WHY: Remove the createdAt indexes for now
    // Sequelize has trouble indexing its own timestamp columns
